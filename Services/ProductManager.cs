...
namespace Services
{
    public class ProductManager : IProductService
    {
        ...
        public Product? GetOneProduct(int id, bool trackChanges)
        {
            ...
            if(product == null)
            {
                throw new Exception("Product not founf !! ");
            }
            return product;
        }
        ...
        public IEnumerable<Product> GetVitrinProducts(bool trackChanges)
        {
            var products = _manager.Product.GetVitrinProducts(trackChanges);
            return products;
        }
